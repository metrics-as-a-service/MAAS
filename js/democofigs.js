    ...
    const demoConfigs = {
        ...
        "Basic": {
            config: {
                ...
                "maxValues": 30,
                "file": {},
                "colNames": ["ID", "CREATE DATE", "STATUS", "PRIORITY", "GEOGRAPHY", "CLOSE DATE", "AGE", "Description"],
        ...
        "State Change": { //final
            config: {
                ...
                "cols": [
                    ...
                    { "colname": "Responsibility", "title": "COUNT BY RESPONSIBILITY", "autoType": "String", "type": "String", "countType": "Count", "chartSize": "Small", "order": [] },
                    { "colname": "ID", "title": "DATA TABLE", "autoType": "String", "type": "Data Table", "countType": "Count", "chartSize": "Medium", "maxEntries": 10, },
                    { "colname": "ID", "title": "DATA DESCRIPTION", "autoType": "String", "type": "Data Description", "countType": "Count", "chartSize": "Medium", },
                ]
            },
        ...
        "Risk": {
            config: {
                ...
                "maxValues": 30,
                "file": {},
                "colNames": ["ID", "CREATE DATE", "STATUS", "Type", "GEOGRAPHY", "CLOSE DATE", "AGE", "Description", "Impact", "Likelihood", "Target Date"],
