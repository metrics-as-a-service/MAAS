    ...
    const demoConfigs = {
        ...
        "Basic": {
            config: {
                ...
                "maxValues": 30,
                "file": {},
                "colNames": ["ID", "CREATE DATE", "STATUS", "PRIORITY", "GEOGRAHPY", "CLOSE DATE", "AGE", "Description"],
                ...
                "cols": [
                    ...
                    { "title": "COUNT BY GEOGRAPHY", "autoTitle": true, "chartSize": "Small", "colname": "GEOGRAPHY", "countif": "", "countType": "Count", "autoType": "String", "type": "String" },
        ...
        "Modified Basic": {
            config: {
                ...
                "cols": [
                    ...
                    { "title": "COUNT BY GEOGRAPHY", "autoTitle": false, "chartSize": "Small", "colname": "GEOGRAPHY", "countif": "", "countType": "Count", "autoType": "String", "type": "String" },
        ...
        "State Change": { //final
            config: {
                ...
                "maxValues": 30,
                "file": {},
                "colNames": ["ID", "When", "From", "To", "Priority", "Responsibility"],
                ...
                "cols": [
                    ...
                    { "colname": "Responsibility", "title": "COUNT BY RESPONSIBILTY", "autoType": "String", "type": "String", "countType": "Count", "chartSize": "Small", "order": [] },
                    { "colname": "ID", "title": "DATA TABLE", "autoType": "String", "type": "Data Table", "countType": "Count", "chartSize": "Medium", "maxEntries": 10, },
                    { "colname": "ID", "title": "DATA DESCRIPTION", "autoType": "String", "type": "Data Description", "countType": "Count", "chartSize": "Medium", },
                ]
            },
        ...
        "Risk": {
            config: {
                ...
                "maxValues": 30,
                "file": {},
                "colNames": ["ID", "CREATE DATE", "STATUS", "Type", "GEOGRAHPY", "CLOSE DATE", "AGE", "Description", "Impact", "Likelihood", "Target Date"],
                ...
                "cols": [
                    ...
                    { "title": "COUNT BY GEOGRAHPY", "autoTitle": false, "chartSize": "Small", "colname": "GEOGRAHPY", "countif": "", "countType": "Count", "autoType": "String", "type": "String" },
